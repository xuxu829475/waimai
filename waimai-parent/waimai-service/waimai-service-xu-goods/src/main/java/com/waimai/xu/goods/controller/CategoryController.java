...
import com.waimai.xu.goods.pojo.Category;
import com.waimai.xu.goods.service.CategoryService;
...
public class CategoryController {
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Category对象",value = "传入JSON数据",required = false) Category category,@PathVariable Long id){
        //设置主键值
        category.setId(id);
